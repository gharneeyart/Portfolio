      ...
      <div className="w-full max-w-2xl bg-white p-8 rounded-lg ">
        <div className="space-y-6">
          ...
          <div>
            ...
            <textarea placeholder='Type your message here...' className="mt-1 block w-full border-[1.5px] border-gray-500 rounded-md p-2 focus:outline-none" rows="5"></textarea>
          </div>
