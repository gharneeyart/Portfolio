...
const Portfolio = () => {
  return (
    <div className='flex flex-col justify-center w-full py-12 items-center mx-auto px-5 md:px-12 border font-roboto'>
        <div className="w-full flex flex-col justify-between">
        <div className="flex flex-col md:flex-row justify-between w-full items-center text-center md:text-start mb-12">
            <div className="">
            <h6 className='text-sm font-semibold'>Recent Projects</h6>
