...
const Home = () => {
  return (
    <div className='flex flex-col md:flex-row items-center  py-12 bg-blue-50 px-2 md:px-12 border font-roboto'>
      <div className="w-full md:w-1/2 flex flex-col justify-between h-full  pt-16 text-center md:text-start">
        <h6 className='text-sm font-semibold'>Hey, I am John</h6>
        ...
        <div className="flex items-center space-x-4 mt-6 justify-center md:justify-start">
          <Link to="contact">
          <button className="bg-violet-700 text-white px-4 py-2 rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50" >Get In Touch</button>
          </Link>
        </div>
      </div>
      <div className="w-full md:w-1/2 flex justify-center mt-10 md:mt-0 md:pt-14">
        <img src={John} alt="Ganiyat's Portrait" className='h-96 w-72 md:w-96 rounded-2xl shadow-lg object-cover'/>
      </div>
    </div>
  );
};
